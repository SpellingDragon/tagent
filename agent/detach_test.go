...
// TestDetachAfter_StopPreventsFire: task.DetachAfter does not close when stop fires
...
// TestDetachAfter_FiresAfterDuration: task.DetachAfter closes after the duration when
// not stopped.
